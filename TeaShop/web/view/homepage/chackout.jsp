<%-- 
    Document   : chackout
    Created on : May 20, 2024, 12:23:52 AM
    Author     : HoangPC
--%>
                        ...
                        <div class="navbar-nav mx-auto">
                            ...
                            <div class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu m-0 bg-secondary rounded-0">
                                    ...
                                    <a href="chackout.jsp" class="dropdown-item active">Chackout</a>
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <th scope="row">
                                                <div class="d-flex align-items-center mt-2">
                                                    <img src="${pageContext.request.contextPath}/img/vegetable-item-3.png" class="img-fluid rounded-circle" style="width: 90px; height: 90px;" alt="">
                                                </div>
                                            </th>
