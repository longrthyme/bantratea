<%-- 
    Document   : slidbar
    Created on : Jun 17, 2024, 10:32:59 AM
    Author     : ADMIN
--%>
              ...
              <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                ...
                <li class="nav-item">
                  ...
                  <ul class="nav collapse false" id="events">
                    <li class="nav-item"><a class="nav-link" href="addBlog.jsp" aria-expanded="false">
                        <div class="d-flex align-items-center"><span class="nav-link-text ps-1">Create an blog</span>
                        </div>
                      </a>
                      <!-- more inner pages-->
                    </li>
