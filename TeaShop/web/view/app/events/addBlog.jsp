<%-- 
    Document   : addBlog
    Created on : Jun 20, 2024, 2:24:10 PM
    Author     : ADMIN
--%>
              ...
              <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                ...
                <li class="nav-item">
                  ...
                  <!-- parent pages--><a class="nav-link dropdown-indicator" href="#events" role="button" data-bs-toggle="collapse" aria-expanded="true" aria-controls="events">
                    <div class="d-flex align-items-center"><span class="nav-link-icon"><span class="fas fa-calendar-day"></span></span><span class="nav-link-text ps-1">Blogs</span>
                    </div>
                  </a>
                  <ul class="nav collapse show" id="events">
                    <li class="nav-item"><a class="nav-link active" href="../../app/events/create-an-event.html" aria-expanded="false">
                    ...
                    <li class="nav-item"><a class="nav-link" href="../../app/events/event-detail.html" aria-expanded="false">
                        <div class="d-flex align-items-center"><span class="nav-link-text ps-1">Blog detail</span>
                        </div>
                      </a>
                      <!-- more inner pages-->
                    </li>
                    <li class="nav-item"><a class="nav-link" href="../../app/events/event-list.html" aria-expanded="false">
                        <div class="d-flex align-items-center"><span class="nav-link-text ps-1">Blog list</span>
                        </div>
                      </a>
                      <!-- more inner pages-->
                    </li>
                    ...
                    <div class="scrollbar list py-3" style="max-height: 24rem;">
                      <h6 class="dropdown-header fw-medium text-uppercase px-card fs--2 pt-0 pb-2">Recently Browsed</h6><a class="dropdown-item fs--1 px-card py-1 hover-primary" href="../../app/events/event-detail.html">
                        <div class="d-flex align-items-center">
                          ...
                          <div class="fw-normal title">Pages <span class="fas fa-chevron-right mx-1 text-500 fs--2" data-fa-transform="shrink-2"></span> Blogs</div>
                        </div>
                      </a>
                ...
                <div class="card-body bg-light">
                    ...
                    <div class="row gx-2">
                      <div class="col-12 mb-3">
                        <label class="form-label" for="event-name">Blog Title</label>
                        <input class="form-control" id="name" type="text" placeholder="Blog Title" />
                      </div>
                      <div class="col-sm-6 mb-3">
                        <label class="form-label" for="start-date">Date create</label>
                        <input class="form-control datetimepicker" id="date" type="text" placeholder="d/m/y" data-options='{"dateFormat":"d/m/y","disableMobile":true}' />
                      </div>
                        <div class="col-12">
                            <div class="border-dashed-bottom my-3">
                               
                                    <label for="options">Choose an option Category :</label>
                                    <select id="category" name="options">
                      ...
                      <div class="col-12">
                        <label class="form-label" for="event-description">Content</label>
