                ...
                <div id="layoutSidenav_content">
                    <main>
                        <div style="margin-top: 20px" class="container-fluid px-4">
                            ...
                            <div class="card mb-4">
                                <div class="h1">                                
                                    <a href="adduser"><ion-icon name="add-circle-outline"></ion-icon> Thêm nhân viên mới</a>                               
                                </div>  
                            </div>                  
                                        ...
                                        <tbody>
                                            <c:forEach items="${listStaff}" var="ls">
                                                <tr>                                                 
                                                    ...
                                                    <td><a href="editstaff?id=${ls.account_id}"><ion-icon name="create-outline"></ion-icon></a>
                                                        <a href="deletestaff?id=${ls.account_id}"> <ion-icon name="trash-outline"></ion-icon></a></td>
                                                </tr>
                                            </c:forEach>
                                        </tbody>
                                    </table>
