...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="toppingmanager">Quản lý Topping</a>
            <!-- Sidebar Toggle-->
                ...
                <div id="layoutSidenav_content">
                    <main>
                        <div style="margin-top: 20px" class="container-fluid px-4">
                            ...
                            <div class="card mb-4">
                                <div class="h1">                                
                                    <a href="addtopping"><ion-icon name="add-circle-outline"></ion-icon> Thêm topping mới</a>                               
                                </div>  
                            </div>                       
                                        ...
                                        <table id="datatablesSimple">
                                            ...
                                            <c:forEach items="${listTopping}" var="ltp">
                                                <tr>                                                 
                                                    ...
                                                    <td><a href="updatetopping?id=${ltp.topping_id}"><ion-icon name="create-outline"></ion-icon></a>
                                                        <a href="deletetopping?id=${ltp.topping_id}"><ion-icon name="trash-outline"></ion-icon></a></td>
                                                </tr>
                                            </c:forEach>
                                        </tbody>
                                    </table>
