...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="rolemanager">Quản lý Role</a>
            <!-- Sidebar Toggle-->
            <button class="btn btn-link btn-sm order-1 order-lg-0 me-4 me-lg-0" id="sidebarToggle" href="#!"><i class="fas fa-bars"></i></button>
            <!-- Navbar Search-->
            <form class="d-none d-md-inline-block form-inline ms-auto me-0 me-md-3 my-2 my-md-0" action="searchrole">
                ...
                <div id="layoutSidenav_content">
                    <main>
                        <div style="margin-top: 20px" class="container-fluid px-4">                           
                           ...
                           <div class="card mb-4">
                                <div class="h1">                                
                                    <a href="addrole"><ion-icon name="add-circle-outline"></ion-icon> Thêm role mới</a>                               
                                </div>  
                            </div>                                
                            <div class="card mb-4">
                                        ...
                                        <table id="datatablesSimple">
                                            ...
                                            <c:forEach items="${listRole}" var="lr">
                                                <tr>                                                 
                                                    <td>${lr.role_id}</td>
                                                    <td>${lr.role_name}</td>                                                   
                                                    <td><a href="editRole?id=${lr.role_id}"><ion-icon name="create-outline"></ion-icon></a>
                                                        <a href="deleterole?id=${lr.role_id}"><ion-icon name="trash-outline"></ion-icon></a></td>
                                                </tr>
                                            </c:forEach>
                                        </tbody>
                                    </table>
