                ...
                <div id="layoutSidenav_content">
                    <main>
                        <div class="container-fluid px-4">
                            ...
                            <form id="switchForm" action="CouponManagement?service=AddCoupon" method="post" >
                                <fieldset>
                                    <legend style="margin-top: 15px;">Thêm Coupon</legend>
                                                ...
                                                <div class="col">
                                                    <nav aria-label="breadcrumb" class="bg-light rounded-3 p-3 mb-4">
                                                        <ol class="breadcrumb mb-0">
                                                            <li class="breadcrumb-item active" aria-current="page">Thông tin coupon được thêm</li>
                                                        </ol>
                                                    </nav>
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="card mb-4" style="padding-left: 10px; padding-right: 10px">
                                                        ...
                                                        <div class="row mb-3 align-items-center" style="padding-top: 10px">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <input type="text" name="couponCode" class="form-control" value="${couponDetail.couponCode}" required="">
                                                        </div>
                                                    </div>
                                                    <div class="row mb-3 align-items-center">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <input type="text" name="description" class="form-control" value="${couponDetail.description}" required="">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row mb-3 align-items-center">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <input type="date" name="validFrom" class="form-control" value="${couponDetail.validFrom}" required="">
                                                        </div>
                                                    </div>
                                                    <div class="row mb-3 align-items-center">
                                                        <div class="col-sm-3">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <input type="date" name="validUntil" class="form-control" value="${couponDetail.validUltil}" required="">
                                                        </div>
                                                    </div>
                                                    <div class="row mb-3 align-items-center">
                                                        <div class="col-sm-3">
                                                    ...
                                                    <div class="row mb-3">
                                                        <div class="col-sm-9 offset-sm-3">
                                                            <button id="singlebutton" name="singlebutton" type="submit" class="btn btn-primary">Thêm</button>
                                                        </div>
                                                    </div>
