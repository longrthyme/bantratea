                                        ...
                                        <tbody>
                                            <c:forEach items="${listUser}" var="lc">
                                                <tr>                                                 
                                                    ...
                                                    <td><a href="editcustomer?id=${lc.account_id}"><ion-icon name="create-outline"></ion-icon></a>
                                                        <a href="delete?id=${lc.account_id}"><ion-icon name="trash-outline"></ion-icon></a></td>
                                                </tr>
                                            </c:forEach>
                                        </tbody>
                                    </table>
