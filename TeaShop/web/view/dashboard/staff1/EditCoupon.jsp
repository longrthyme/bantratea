...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="chartorderday">Quản lý Coupon</a>
            <!-- Sidebar Toggle-->
                ...
                <div id="layoutSidenav_content">
                    <main>
                        <div class="container-fluid px-4">
                            ...
                            <form id="switchForm" action="CouponManagement?service=EditCoupon" method="post">
                                <fieldset>
                                    <legend style="margin-top: 15px;">Cập nhật Coupon</legend>
                                                ...
                                                <div class="col">
                                                    <nav aria-label="breadcrumb" class="bg-light rounded-3 p-3 mb-4">
                                                        <ol class="breadcrumb mb-0">
                                                            <li class="breadcrumb-item active" aria-current="page">Thông tin của Coupon</li>
                                                        </ol>
                                                    </nav>
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-lg-8">
                                                    <div class="card mb-4" style="padding-left: 10px; padding-right: 10px">
                                                        ...
                                                        <div class="row mb-3 align-items-center" style="padding-top: 10px">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <input type="text" name="couponCode" class="form-control" value="${couponDetail.couponCode}" readonly="">
                                                        </div>
                                                    </div>
                                                    <div class="row mb-3 align-items-center">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <input type="text" name="description" class="form-control" value="${couponDetail.description}" >
                                                        </div>
                                                    </div>
                                                            ...
                                                            <select name="discountType" class="form-control" required>
                                                                <c:forEach items="${discountsType}" var="dis">
                                                                    <option value="${dis.discountTypeID}" 
                                                                            <c:if test="${dis.discountTypeID == couponDetail.discountType}">
                                                                                selected
                                                                            </c:if>>
                                                    ...
                                                    <div class="row mb-3 align-items-center">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <input type="date" name="validFrom" class="form-control" value="${couponDetail.validFrom}" >
                                                        </div>
                                                    </div>
                                                    <div class="row mb-3 align-items-center">
                                                        <div class="col-sm-3">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <input type="date" name="validUntil" class="form-control" value="${couponDetail.validUltil}" >
                                                        </div>
                                                    </div>
                                                    <div class="row mb-3 align-items-center">
                                                        <div class="col-sm-3">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <select name="status" class="form-control" required>
                                                                <option value="active" ${'active' eq couponDetail.couponStatus ? "selected" : ""}>Active</option>   
                                                                <option value="inactive" ${'inactive' eq couponDetail.couponStatus ? "selected" : ""}>Inactive</option>   
                                                            </select>
                                                        </div>
                                                    </div>
                                                    <div class="row mb-3">
                                                        <div class="col-sm-9 offset-sm-3">
                                                            <button id="singlebutton" name="singlebutton" type="submit" class="btn btn-primary">Cập nhật</button>
                                                        </div>
                                                    </div>
                                                    <%
