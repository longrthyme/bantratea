    ...
    throws ServletException, IOException {
        response.setContentType("text/html;charset=UTF-8");            
            ...
            if (gender.isEmpty() && status.isEmpty()) {
                ...
                List<Accounts> listByGender = gender.equals("Male") ? dao.getAllAccountMale() : dao.getAllAccountFemaleStaff();
                ...
                if (listByStatus.isEmpty()) {
                    ...
                    request.setAttribute("listStaff", listByStatus);
                }
                request.setAttribute("status", status);
                request.getRequestDispatcher("./view/dashboard/admin/staffManagement.jsp").forward(request, response);
            } else {
                ...
                if (listByGenderAndStatus.isEmpty()) {
                    ...
                    request.setAttribute("listStaff", listByGenderAndStatus);
                }
