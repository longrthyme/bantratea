...
public class StaffFilter implements Filter {
	...
	if (debug) log("StaffFilter:DoBeforeProcessing");
	...
	*/
	...
	throws IOException, ServletException {
	if (debug) log("StaffFilter:DoAfterProcessing");
	...
	*/
	...
	if (debug) log("StaffFilter:doFilter()");
	...
	if (filterConfig == null) return ("StaffFilter()");
